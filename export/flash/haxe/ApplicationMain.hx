...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/data/Debug.oel");
		types.push (lime.Assets.AssetType.TEXT);
		...
		urls.push ("assets/images/OpenGameJam Tile.0001.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/images/Tile.0001.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/RotoscopBits/Take1.mp4");
		types.push (lime.Assets.AssetType.BINARY);
		
		
		urls.push ("assets/RotoscopBits/Take1Mod.mp4");
		types.push (lime.Assets.AssetType.BINARY);
