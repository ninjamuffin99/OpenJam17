...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/images/OpenGameJam Tile.0001.png", __ASSET__assets_images_opengamejam_tile_0001_png);
		type.set ("assets/images/OpenGameJam Tile.0001.png", AssetType.IMAGE);
		className.set ("assets/images/Tile.0001.png", __ASSET__assets_images_tile_0001_png);
		type.set ("assets/images/Tile.0001.png", AssetType.IMAGE);
		className.set ("assets/music/music-goes-here.txt", __ASSET__assets_music_music_goes_here_txt);
		type.set ("assets/music/music-goes-here.txt", AssetType.TEXT);
		className.set ("assets/RotoscopBits/Take1.mp4", __ASSET__assets_rotoscopbits_take1_mp4);
		type.set ("assets/RotoscopBits/Take1.mp4", AssetType.BINARY);
		className.set ("assets/RotoscopBits/Take1Mod.mp4", __ASSET__assets_rotoscopbits_take1mod_mp4);
		type.set ("assets/RotoscopBits/Take1Mod.mp4", AssetType.BINARY);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/images/OpenGameJam Tile.0001.png";
		path.set (id, id);
		
		type.set (id, AssetType.IMAGE);
		id = "assets/images/Tile.0001.png";
		path.set (id, id);
		...
		type.set (id, AssetType.TEXT);
		id = "assets/RotoscopBits/Take1.mp4";
		path.set (id, id);
		
		type.set (id, AssetType.BINARY);
		id = "assets/RotoscopBits/Take1Mod.mp4";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_images_opengamejam_tile_0001_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_images_tile_0001_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep @:bind #if display private #end class __ASSET__assets_music_music_goes_here_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_rotoscopbits_take1_mp4 extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_rotoscopbits_take1mod_mp4 extends flash.utils.ByteArray { }
...
@:image("assets/images/OpenGameJam Tile.0001.png") #if display private #end class __ASSET__assets_images_opengamejam_tile_0001_png extends lime.graphics.Image {}
@:image("assets/images/Tile.0001.png") #if display private #end class __ASSET__assets_images_tile_0001_png extends lime.graphics.Image {}
@:file("assets/music/music-goes-here.txt") #if display private #end class __ASSET__assets_music_music_goes_here_txt extends lime.utils.Bytes {}
@:file("assets/RotoscopBits/Take1.mp4") #if display private #end class __ASSET__assets_rotoscopbits_take1_mp4 extends lime.utils.Bytes {}
@:file("assets/RotoscopBits/Take1Mod.mp4") #if display private #end class __ASSET__assets_rotoscopbits_take1mod_mp4 extends lime.utils.Bytes {}
